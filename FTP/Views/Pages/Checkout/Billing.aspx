<%@ Page Title="" Language="C#" MasterPageFile="~/Views/MasterPages/Interior.Master" AutoEventWireup="true" CodeBehind="Billing.aspx.cs" Inherits="ASI.Web.Views.Pages.Checkout.Billing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div class="checkout">
		...
		<EPiServer:Property ID="Property2" runat="server" CustomTagName="h2" PropertyName="BillingHeader" />
		<div class="divide">
			<div class="first">
				<EPiServer:Property ID="Property6" runat="server" PropertyName="BillingAddress" />
				<div class="read">
					<ul>
						<li>
							<strong>
						...
						<li><a href="#" class="btn secondary smallBtn modalTrigger">Edit Info</a></li>
					</ul>
				</div>
			</div>
			<div class="second edit ad verticalSec right">
				<div class="content">
					<EPiServer:Property ID="Property1" runat="server" PropertyName="DesignerInfo" />
					<ul>
						<li class="two">
							<ul>
								<li>
									<asp:Label ID="ADNameLbl" AssociatedControlID="ADName" runat="server">Name:</asp:Label>
									<asp:TextBox ID="ADName" runat="server"></asp:TextBox>
								</li>
								<li>
									<asp:Label ID="ADCompanyLbl" AssociatedControlID="ADCompany" runat="server">Company:</asp:Label>
									<asp:TextBox ID="ADCompany" runat="server"></asp:TextBox>
								</li>
							</ul>
						</li>
						<li class="two">
							<ul>
								<li>
									<asp:Label ID="ADProjectLbl" AssociatedControlID="ADProject" runat="server">Project Name:</asp:Label>
									<asp:TextBox ID="ADProject" runat="server"></asp:TextBox>
								</li>
								<li>
									<asp:Label ID="ADCityLbl" AssociatedControlID="ADCity" runat="server">City:</asp:Label>
									<asp:TextBox ID="ADCity" runat="server"></asp:TextBox>
								</li>
							</ul>
						</li>
						<li class="two">
							<ul>
								<li>
									<asp:Label ID="ADStateLbl" AssociatedControlID="ADState" runat="server">State/Province:</asp:Label>
									<asp:TextBox ID="ADState" runat="server"></asp:TextBox>
								</li>
								<li>
									<asp:Label ID="ADCountryLbl" AssociatedControlID="ADCountry" runat="server">Country:</asp:Label>
									<asp:TextBox ID="ADCountry" runat="server"></asp:TextBox>
								</li>
							</ul>
						</li>
					</ul>
		...
		<div class="checkoutModal billing">
			<div class="edit modalWrap">
				...
				<ul>
					...
					<li>
						<asp:LinkButton ID="lbUpdateBillingAddress" runat="server" Text="Save" CssClass="save btn"
