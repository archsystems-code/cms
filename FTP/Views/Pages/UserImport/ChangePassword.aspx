<%@ Page Title="" Language="C#" MasterPageFile="~/Views/MasterPages/Interior.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="ASI.Web.Views.Pages.UserImport.ChangePassword" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel runat="server" ID="pnlAccount" CssClass="updateAccount">
        <EPiServer:Property ID="Header" PropertyName="Header" runat="server" CustomTagName="h2" />
        <div class="register registration" runat="server" id="RegisterDiv">
            ...
            <asp:CustomValidator runat="server" ID="InvalidUserName" ValidationGroup="create"
                Display="None" ErrorMessage="This username has already been used. Please use another one."></asp:CustomValidator>
            <asp:CustomValidator runat="server" ID="InvalidEmail" ValidationGroup="create"
                Display="None" ErrorMessage="This email has already been used. Please use another one."></asp:CustomValidator>
            <div class="requestThirds password">
                <EPiServer:Property ID="NewPassword" PropertyName="MainBody" runat="server" />
                <asp:Label ID="Label14" AssociatedControlID="UserName" runat="server">
                    Username
                    <sup>*</sup></asp:Label>
            ...
            <div class="twoThirds">
                <EPiServer:Property ID="UpdateInfo" PropertyName="UpdateInfo" runat="server" />
            ...
            <div class="requestThirds noMarginRight">
                ...
                <asp:LinkButton ID="ButtonRegister" runat="server" Text="Confirm My Account" CssClass="btn"
    ...
    <EPiServer:Property runat="server" PropertyName="ErrorMessage" ID="propErrorMessage" Visible="false" />
</asp:Content>
