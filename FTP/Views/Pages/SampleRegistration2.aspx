<%@ Page Title="" Language="C#" MasterPageFile="~/Views/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="SampleRegistration2.aspx.cs" Inherits="ASI.Web.Views.Pages.SampleRegistration2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="registrationWrapper">
        ...
        <div class="welcomeText"><p>
            Welcome! Thank you for your interest in requesting samples of ASI materials.<br /><br />
            If you are a <strong>design professional</strong> and have previously registered with ASI, please sign in with your email and password. First time requesting samples? Click on the 'register' button below. Once logged in, you will then be able to request samples for your projects from each of our distinctive collections.<br /><br />
            Are you a <strong>design student or educator</strong>? Please fill out the easy-to-use form below.<br /><br />
            <small>Note: Architectural Systems has changed our shipping and handling policy to ensure the same level of service you have come to expect from our company for over 20 years. While ASI will continue to supply stock samples free of charge, there will be a minimal processing fee for each request. These charges will be reflected when you select your shipping method at checkout. <strong>SAMPLES WILL NOT BE SHIPPED TO PO BOXES</strong>.</small>
        </p></div>
        <div><img src="http://www.archsystems.com/images/request-samples.png" /></div>
    </div>
        
    <div class="formsWrapper">
        <div class="requestThirds">
            <h2>For returning customers...</h2>
                <p>Please log in below:</p>
                    <label>Email Address:</label>
                    <asp:TextBox runat="server" ID="loginEmail" />
                    <label>Password:</label>
                    <asp:TextBox runat="server" ID="loginPassword" TextMode="Password" />
                    <asp:LinkButton runat="server" ID="lbLogin" CssClass="btn">Log In</asp:LinkButton>
        ...
        <div class="requestThirds">
            ...
            <p>If you have not previously registered with ASI, please click below and fill out your information to expedite the processing of your sample request.</p>
        ...
        <div class="requestThirds noMarginRight">
            ...
            <p>Architectural Systems has a limited sample program for educational purposes. Please fill out the form below.</p>
        ...
        <div class="studentEducators">
            ...
            <p>
                Thank you for your interest in Architectural Systems!<br /><br />
                Although ASI is involved in a broad range of design education initiatives for students, due to high demand, we have to limit individual requests to no more than three samples in order to accommodate everyone. There is no charge for samples; however, ASI requires a $30 shipping and handling fee for stock sample requests to be processed in the continental U.S.*<br /><br />
                Request up to three individual samples you are interested in by their sku number (Sorry, but sample chains/boxes are not available to students/educators).<br /> 
                Please note that ASI reserves the right to select samples closest to your choice based on availability.<br /><br />
                <small>*For sample requests from outside the continental U.S., additional shipping costs apply and will be added at checkout. Please contact <a href="mailto:sales@archsystems.com">sales@archsystems.com</a> if you have an any questions.</small>
            </p>

        </div>

        <div class="register" runat="server" style="display: none" id="RegisterDiv">
