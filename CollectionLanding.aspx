    ...
    <script type="text/javascript">
      ...
      $(document).ready(function () {
        ...
        if (hasDigitalCatalog) {
          ...
          $catalog.html("<svg version='1.1' id='plusIcon' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 24 24' style='enable-background:new 0 0 24 24;' xml:space='preserve' width='45'> <style type='text/css'>.plus{fill:#D78F54;}</style><path class='plus' d='M12,0C5.4,0,0,5.4,0,12s5.4,12,12,12s12-5.4,12-12S18.6,0,12,0z M19,14h-5v5h-4v-5H5v-4h5V5h4v5h5V14z'/></svg><p style='color: #d78f54; font-family: HelveticaNeueLTStd-Th, Helvetica Neue LT Std; font-size: 18px; font-weight: lighter; margin-bottom: 0; margin-left: 10px;'>Catalog</p>")
        ...
        if ($(".tabsContainer > ul > li").length === 1) {
          ...
          $($("#instructions strong span")[0]).prepend('<svg version="1.1" id="pictures" class="Pictures" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 212 51.8" style="vertical-align: bottom;" xml:space="preserve" width="150" height="100%"><style type="text/css">.st0{fill:rgb(97, 144, 128);}.st1{font-size:20.25px;font-family:HelveticaNeueLTStd-Th, Helvetica Neue LT Std; font-weight: lighter;}.st3{fill:none;}.st4{fill:rgb(97, 144, 128);}.st5{fill:rgb(97, 144, 128);}.st6{fill:rgb(97, 144, 128);}</style><text transform="matrix(1 0 0 1 46.3057 36.5787)" class="st0 st1 st2">product images,</text><path class="st3" d="M25.9,0C11.6,0,0,11.6,0,25.9s11.6,25.9,25.9,25.9s25.9-11.6,25.9-25.9C51.7,11.6,40.2,0,25.9,0L25.9,0L25.9,0"></path><polygon class="st0" points="35.4,12.8 24,24.3 35.5,35.8 "></polygon><polygon class="st4" points="35.4,12.8 24,24.3 12.4,12.7 "></polygon><polygon class="st5" points="12.7,35.7 24.1,24.3 12.5,12.8 "></polygon><polygon class="st6" points="35.5,35.7 24.1,24.3 12.5,35.9 "></polygon><polygon class="st0" points="36.9,15.4 36.9,36.9 15.6,36.9 15.6,39.1 39.3,39.1 39.3,15.4 "></polygon></svg>')
        }
